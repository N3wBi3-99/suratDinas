                  ...
                  <table id="example1" class="table table-bordered table-striped" style="font-size:100%">
                    ...
                    $no=1;
                      ...
                      ?><tr>
                          ...
                          <td><?php echo $bc1['nmr_surat']; ?><br>
                              <?php echo $bc1['tgl_surat']; ?>
                          </td>
                          <td><?php echo $bc1['prihal']; ?></td>
                          <td><?php echo $bc1['pengirim']; ?></td>
                          <td><?php echo $bc1['lampiran']; ?></td>
                          <td>terdownload sebanyak : <?php echo $bc1['status_download']; ?><br>
                          <?php echo $bc1['keterangan']; ?></td>
                          <td align="center">
                              <a class="action" target="_blank" href="file_unduh.php?kd=<?php echo $bc1['kd_surat']; ?>" style="padding:2.3px 4px 2.3px 8px;" >
