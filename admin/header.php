...
<html>
  <head>
    ...
    <title>Arsip Surat Biro Tata Pemerintahan Provinsi Jawa Tengah</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <span style="color:white; font-size:30;"><b>BIRO TATA PEMERINTAHAN PROVINSI JAWA TENGAH</b></span>
        ...
        <section class="sidebar"><br/>
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <pixels>Hi.. Admin Surat<?php// echo $nama;?></p>
